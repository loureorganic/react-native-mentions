...
const MentionsTextInput = (props, forwardedRef) => {
  ...
  const [previousTriggerPos, setPreviousTriggerPos] = (0, _react.useState)(0);
  const [matchTrigger, setMatchTrigger] = (0, _react.useState)(new RegExp());
  const [suggestionRowHeight] = (0, _react.useState)(new _reactNative.Animated.Value(0));
  (0, _react.useEffect)(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, null, /*#__PURE__*/_react.default.createElement(Input, {
    ...
    renderItem: rowData => {
      return props.renderSuggestionsRow(rowData, stopTracking, e => {
        ...
        setPreviousTriggerPos(e.selection.start);
      });
    }
  }))));
};
